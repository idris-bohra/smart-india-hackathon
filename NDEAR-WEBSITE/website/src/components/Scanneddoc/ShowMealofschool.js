...
export default function ShowMealofschool() {
  ...
  useEffect(() => {
    ...
    async function fun(){
        ...
        axios.get(`http://localhost:${process.env.REACT_APP_SERVER}/getMealconsumptionForSchool`,  {headers : {"Content-Type" : "application/json" }}).then((result)=>{
